...
for dataset in a9a ijcnn1 w8a mushrooms phishing splice dna.scale pendigits usps sector.scale_sp
do
    ...
    bash bash_files/${method}/${method}_cmp_ratio.sh ${kernel} ${dataset} 0.9
